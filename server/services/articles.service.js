...
const getUsersArticleById = async (_id) => {
  try {
    ...
    if (article.status === "draft") {
      throw new ApiError(httpStatus.BAD_REQUEST, "sorry you're not allowed");
    }
...
const adminPaginteArticles = async (req) => {
  try {
      let aggQueryArray = [];
